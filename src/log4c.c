...
str_to_level_conver pairs[] = {
    {"LOG_TRACE", LOG_TRACE},   {"LOG_DEBUG", LOG_DEBUG},
    {"LOG_INFO", LOG_INFO},     {"LOG_WARNING", LOG_WARNING},
    {"LOG_ERROR", LOG_ERROR},   {"LOG_CRITICAL", LOG_CRITICAL},
    {"LOG_SEVERE", LOG_SEVERE}, {"LOG_FATAL", LOG_FATAL},
    {"LOG_NONE", LOG_NONE},
};
...
static void DestroyLog() { HashMapDestroy(&(g_map), freeModual, freeLogs); }
/******************* LOG FUNCTIONS *******************/
...
void PrintToFile(Zlog _log, log_level_enum _lLevel, const char* _file,
                 int _line, char* fmt, ...) {
    va_list ap;
    time_t current_time;
    char* c_time_string;
